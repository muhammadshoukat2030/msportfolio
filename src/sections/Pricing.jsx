...
const Pricing = () => {
  ...
  return (
    ...
    <section id="pricing" className="py-24 px-6 max-w-7xl mx-auto bg-[#030303] scroll-mt-20">
      ...
      <div className="max-w-xl mx-auto velocity-card !p-10 mb-20 border border-white/10 shadow-2xl bg-[#0A0A0A] rounded-2xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Starter */}
        <div className="velocity-card !p-10 flex flex-col border border-white/5 rounded-2xl bg-[#0A0A0A]">
        ...
        <div className="velocity-card !p-10 border-purple-500/50 relative transform md:scale-105 shadow-[0_0_40px_rgba(147,51,234,0.1)] bg-[#0A0A0A] rounded-2xl border">
        ...
        <div className="velocity-card !p-10 flex flex-col border border-white/5 rounded-2xl bg-[#0A0A0A]">
          ...
          <a href="#contact" className="text-center border border-white/10 hover:bg-white/5 py-3 rounded-xl font-bold transition-all text-white">Contact Us</a>
        </div>
      </div>
    </section>
  );
